...
import DashboardCard from '../components/dashboard/DoubtsCard';
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M12 17V17.01M12 14C12 11 15 12 15 9C15 7.34315 13.6569 6 12 6C10.3431 6 9 7.34315 9 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      )
    },
    {
      ...
      <main className="dashboard-content">
        {!activeSection ? (
          ...
          <div className="section-content">
            ...
            {/* Add your section content here based on activeSection */}
            <h2>{activeSection.charAt(0).toUpperCase() + activeSection.slice(1)}</h2>
            {/* Add specific section components here */}
          </div>
        )}
      </main>
    </div>
